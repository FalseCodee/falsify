...
public class ModeSettingItem extends SettingItem<ModeSetting>{
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        drawCenteredTextWithShadow(matrices, Falsify.mc.textRenderer, setting.getName() + ": " + setting.getMode(), (int)(x + width/2), (int)(y + height/2 - Falsify.mc.textRenderer.fontHeight/2), textColor.getRGB());
    }
}
