...
public class CosmeticManager {
    ...
    public static void render(LivingEntity livingEntity, EntityModel<?> model, float f, float tickDelta, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int lightLevel) {
